...
// Card do Connect: superfície, borda de 1px e raio de 16px. Sem sombra em
// repouso — no DS a sombra é da camada elevada (modal, dropdown), não do card.
...
const CardHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("flex flex-col space-y-1 px-4 py-3.5", className)} {...props} />
  )
)
